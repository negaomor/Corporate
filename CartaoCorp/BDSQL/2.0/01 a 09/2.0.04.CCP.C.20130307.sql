------------------------------------------------------------------------------------------------------
--	
--	2.0.04.CCP.C.20130307
--  
--	crtACSOPRGCRRodape: criação de tabela
--  Data: 07/03/2013		Autor: rafaelrau
--	Versão:	1.0.04.CCP.C.20130222
--
------------------------------------------------------------------------------------------------------
...
SELECT	@versao = '2.0.04.CCP.C.20130307',
		@descricao = 'crtACSOPRGCRRodape: criação de tabela',
		@idUser = 1,
...
/****** Object:  Table [dbo].[crtACSOPRGCRRodape]    Script Date: 03/07/2013 13:44:17 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[crtACSOPRGCRRodape](
 ...
 CONSTRAINT [PK_crtACSOPRGCRRodape] PRIMARY KEY CLUSTERED 
(
	[IdRodape] ASC
