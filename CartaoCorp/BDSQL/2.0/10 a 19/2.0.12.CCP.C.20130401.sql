------------------------------------------------------------------------------------------------------
--	
--	2.0.12.CCP.C.20130401.sql
--  
--	crpACSOIDTSC_RCabecalho: criação de tabela
--  Data: 01/04/2013		Autor: rafaelrau
--	Versão:	2.0.12.CCP.C.20130401
--
------------------------------------------------------------------------------------------------------
...
SELECT	@versao = '2.0.12.CCP.C.20130401',
		@descricao = 'crpACSOIDTSC_RCabecalho: criação de tabela',
		@idUser = 1,
...
/****** Object:  Table [dbo].[crpACSOIDTSC_RCabecalho]    Script Date: 04/01/2013 17:51:43 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[crpACSOIDTSC_RCabecalho](
	[IdRetIdentCab] [int] IDENTITY(1,1) NOT NULL,
 ...
 CONSTRAINT [PK_crpACSOIDTSC_RCabecalho] PRIMARY KEY CLUSTERED 
(
	[IdRetIdentCab] ASC
